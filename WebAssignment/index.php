...
<body>
    ...
    <section id="frontPage">
        <div class="container-lg">
            <div class="row justify-content-center allign-items-center"> <!--all columns in cetner-->
                <div class="col-md-5 text-center text-md-start">
                    <h1>
                        <div class="display-2">Penciluxe</div>
                        <div class="display-5">Think Positive, Think Stationery</div>
                    </h1>
                    <p class="lead my-4 text-muted">View all of the trending stationery</p>
                ...
                <div class="col-md-5 text-center d-none d-md-block"> <!--display as block when we get to medium screens-->
                    <img class="img-fluid bg-light bg-gradient" src="assets/pencilCover.jpg" alt="pencilCover">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container-lg">
        <span><p class="text-light   py-2  px-4 fw-bold" style="background-color: #C50E51;">SPECIAL OFFERS</p></span>
        <div class="row row-cols-2">
          <div class="col"><img class="img-fluid bg-light bg-gradient" src="assets/deals.png" alt="pencilCover"></div>
          <div class="col"><img class="img-fluid bg-light bg-gradient" src="assets/deals2.png" alt="pencilCover"></div>
        </div>
    ...
    <div class="row mx-auto container-lg">
        <span><p class="text-light   py-2  px-4 fw-bold" style="background-color: #C50E51;">Trending Products</p></span>

    <?php include('getProducts.php');?>  <!--takes code from getproducts page. This gets all the prodcyts from the database. ->

    <?php while($row= $trending_products->fetch_assoc()){ ?>  <!--product-->
        <div class="product text-center col-lg-3 col-md-1 col-sm-4">
            <img class="img-fluid mb-3" src="assets/<?php echo $row['product_Image']; ?>"/>  <!--echo a row from the array, this is used to show the specific product information. -->
            <div class="star">
      ...
      <div id="carouselExampleIndicators" class="carousel slide h-50">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="assets/deals.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/deals2.png" class="d-block w-100" alt="...">
          </div>
        </div>
