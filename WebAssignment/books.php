...
<body>
        ...
        <div class="container-fluid align-center">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link mx-3" href="books.php" style="color: #C50E51; font-weight: 900;">Books</a>
                </li>
            ...
            <div class="row justify-content-center allign-items-center"> <!--all columns in cetner-->
                <div class="col-md-4 text-center text-md-start">
                    <h1>
                        ...
                        <div class="display-5">View all of our books!</div>
                    </h1>
                    <p class="lead my-4 text-muted">The best place to find the most overpriced books in the world!</p>
                </div>
                <div class="col-md-5 text-center d-none d-md-block"> <!--display as block when we get to medium screens-->
                    <img class="img-fluid bg-light bg-gradient" src="assets/booksCover.jpg" alt="pencilCover">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="row mx-auto container-lg">
        <span><p class="text-light   py-2  px-4 fw-bold" style="background-color: #C50E51;">BOOKS</p></span>

    <?php include('getBooks.php');?> <!--get code from get books file, only products in book category are shown-->
