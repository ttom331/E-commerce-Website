...
if(isset($_POST['payment_btn']) && isset( $_POST['order_ID'] )) {
    ...
    if ($order_status == "Paid"){
      ...
      $payment_Order_Details = $stmt->get_result();
    }
...
<body>
    ...
    <!--Payment-->
    <?php  while($row= $payment_Order_Details->fetch_assoc()){?>
    <section class="my-5 py-5">
        <div class="container text-center mt-3 pt-5">
            ...
            <form id="checkout-Form" method="POST" action="purchaseSuccess.php">
              <div class="form-group checkout-btn-container text-center">
                <p>Order ID: <?php echo $row['order_ID'];?></p>
                <p>Total Payment: £<?php echo $row['order_Cost'];?></p>
                <input class="btn btn-primary" type="submit" value="Pay Now" name="purchase_Order"/>
              </div>
                <div class="form-group checkout-large-element-pay">
                    <label class="my-2 mx-1">Card Holder Name</label>
                    <input type="text" class="form-control" id="checkout-Name" name="name" placeholder="Name" required/>
                </div>
                <div class="form-group checkout-large-element-pay">
                    <label class="my-2 mx-2">Card Number</label>
                    <input type="text" class="form-control" id="checkout-Email" name="email" placeholder="0000 0000 0000 0000" data-mask="0000 0000 0000 0000"required/>
                </div>
                <div class="form-group checkout-small-element-pay">
                    <label class="my-2 mx-2">Expiry Date</label>
                    <input type="text" class="form-control" id="phone-number" name="phone" placeholder="00 / 00" data-mask="00 / 00" required/>
                </div>
                <div class="form-group checkout-small-element-pay">
                    <label class="my-2 mx-2">CVV</label>
                    <input type="text" class="form-control" id="checkout-City" name="city" placeholder="CVV" data-mask="000"  required/>
                </div>
