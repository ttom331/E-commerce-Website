...
<body>
    ...
    <section class="container single-product pt-5 px-4">
        <div class="row mt-5">
            <?php while($row = $product->fetch_assoc()){ ?>

            <div class="col-lg-5 col-md-6 col-sm-12">
                <img class="img-fluid w-100 pb-1" src="assets/<?php echo $row['product_Image']; ?>"/>
            ...
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <form method="POST" action="basket.php">
                  <input type="hidden" name="customer_ID2" value="<?php echo $customer_ID2; ?>"/>
                  <input type="hidden" name="product_ID" value="<?php echo $row['product_ID']; ?>"/>
                  <input type="hidden" name="product_Image" value="<?php echo $row['product_Image']; ?>"/>
                  <input type="hidden" name="product_Name" value="<?php echo $row['product_Name']; ?>"/>
                  <input type="hidden" name="product_Price" value="<?php echo $row['product_Price']; ?>"/>
                  <input type="number" name="product_Quantity" value="1"/>
                  <button class="buy-btn" type="submit" name="add_To_Basket">Add to Basket</button>
                </form>
                <form method="POST" action="wishlist.php">
                  ...
                  <button class="wish-btn mt-3" type="submit" name="add_To_Wishlist">Add to Wishlist</button>
                </form>
                <h4 class="mt-5 mb-5">Product Details</h4>
                <spam><?php echo $row['product_Description']; ?></spam>
            </div>
    ...
    <section id="Trending">
      <div class="row mx-auto container-lg">
        <div class="container mt-2">
                <h2 class= "font-weight-bold">About Product</h2>
                <hr>
